...
class Column {
   ...
   * @param {boolean} [column.isPrimary=false] Whether or not this column is
   *        a primary key.
   * @param {object} [column.converter={}] An optional converter object
   *        containing onRetrieve and/or onSave methods.  These methods will be
   *        called when a column is serialized after a select, and before the
   *        column is saved to the database, respectively.
   */
  constructor(column) {
